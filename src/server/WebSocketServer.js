...
import { getGlobalLeaderboard, savePlayerScore } from './db.js';
    ...
    _updateGlobalScores(roomCode, newScores = {}) {
        ...
        PLAYERS.forEach((playerId) => {
            ...
            if (delta !== 0) {
                ...
                const newTotal = existing + delta;
                this.globalScores.set(playerName, newTotal);
                savePlayerScore(playerName, playerName, newTotal).catch(console.warn);
            }
